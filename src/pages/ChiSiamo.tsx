...
const TEAM_MEMBERS = [
  ...
  { iniziali: "FC", immagine: "https://rpzbiqzjyculxquespos.supabase.co/storage/v1/object/public/avatars/avatars/Flavia_C.webp", nome: "Flavia C.", ruolo: "Craft Designer", filosofia: "Speciali", bio: "Amante dei lavori artigianali perché unici, ma attenti a non farla arrabbiare perché usa i ferri da uncinetto come un ninja." },
  ...
  { iniziali: "LM", immagine: "https://rpzbiqzjyculxquespos.supabase.co/storage/v1/object/public/Images/Lorenzo_M.webp", nome: "Lorenzo M.", ruolo: "Web Copywriter", filosofia: "Trek urbano", bio: "Scrive storie di passi, scorci urbani e itinerari alternativi nascosti nelle pieghe delle città." },
  { iniziali: "RS", immagine: "https://rpzbiqzjyculxquespos.supabase.co/storage/v1/object/public/Images/Rodolfo_S.webp", nome: "Rodolfo S.", ruolo: "Co-Fondatore & Guida AIGAE", filosofia: "Cammini", bio: "Ingegnere nella vita precedente, Guida ambientale escursionistica certificata AIGAE e appassionato di cammini." },
];
          ...
          <div className="bg-white rounded-[2.5rem] overflow-hidden border border-stone-50 transform-gpu" style={{ boxShadow: "0 0 80px -10px rgba(14,165,233,0.18), 0 0 40px -20px rgba(68,64,60,0.1), 0 25px 50px -12px rgba(0,0,0,0.1)" }}>
            <div className="flex flex-col md:flex-row min-h-[360px]">
              <div className="w-full md:w-2/5 relative h-48 md:h-auto overflow-hidden">
                <img src="https://rpzbiqzjyculxquespos.supabase.co/storage/v1/object/public/Images/Paesaggio%20innevato.webp" alt="Paesaggio innevato" className="absolute inset-0 w-full h-full object-cover object-center" loading="lazy" decoding="async" />
