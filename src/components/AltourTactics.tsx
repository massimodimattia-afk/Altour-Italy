              ...
              <div className="w-full bg-stone-100 border border-stone-200 p-5 rounded-2xl text-left shrink-0">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-[12px] text-stone-600 font-medium leading-relaxed">
                    Il percorso per acquisire le competenze da <strong className="text-stone-900">Guida Ambientale Escursionistica</strong> prevede moduli specifici. Lo staff ti contatterà per definire l'iter didattico.
                  </p>
                </div>
              </div>
            )}
