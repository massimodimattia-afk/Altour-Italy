...
const STEPS: Step[] = [
  // --- SEZIONE 1: PROFILAZIONE (DOMANDE A-E, NON VALUTATE) ---
  ...
  { id: 'obiettivo', kind: 'profiling', type: 'multi', tag: 'I tuoi obiettivi', question: 'Quale obiettivo hai frequentando un corso di escursionismo? (anche più scelte)', allowOther: true, options: [ { id: 'a', label: 'Saper leggere ed interpretare una carta topografica e non dipendere da strumenti elettronici' }, { id: 'b', label: 'Saper usare correttamente carta, bussola e altimetro' }, { id: 'c', label: 'Avere le conoscenze e la consapevolezza per progettare una escursione in ogni stagione dell\'anno' }, { id: GAE_OPTION_ID, label: 'Avere le basi per diventare una Guida Ambientale Escursionistica' } ] },
  
  // --- SEZIONE 2: DOMANDE DI MERITO (DOMANDE 1-10 BASE) ---
  { id: 'q1', kind: 'knowledge', type: 'single', tag: 'Glossario', question: 'Quale definizione associeresti alla parola PEDANCA?', options: [ { id: 'a', label: 'Parete continua di pali squadrati e affiancati, infissi nel terreno' }, { id: 'b', label: 'Diramazione secondaria di un massiccio montuoso' }, { id: 'c', label: 'Elevatore per liquidi o materiali terrosi' }, { id: 'd', label: 'Impianto per il trasporto di merci' }, { id: 'e', label: 'Nessuna delle precedenti', isCorrect: true } ], courseLevel: 'base', weight: 1, moduleName: 'Glossario' },
  { id: 'q2', kind: 'knowledge', type: 'single', tag: 'Simboli', scenario: 'Stai svolgendo una prova di orienteering e sulla mappa trovi un simbolo di colore nero: un cerchio con al suo centro un punto.', question: 'Che cosa dovrai cercare?', options: [ { id: 'a', label: 'Un albero isolato' }, { id: 'b', label: 'Un cippo', isCorrect: true }, { id: 'c', label: 'Una fontana con acqua potabile' }, { id: 'd', label: 'Un oggetto particolare' }, { id: 'e', label: 'Un masso con una cavità centrale' } ], courseLevel: 'base', weight: 2, moduleName: 'Lettura e Interpretazione di una Carta Geografica: Simboli' },
  { id: 'q3', kind: 'knowledge', type: 'single', tag: 'Glossario', question: 'Quale definizione associeresti alla parola IMPLUVIO?', options: [ { id: 'a', label: 'Manufatto costruito lungo l\'alveo di un torrente' }, { id: 'b', label: 'Depressione di forma arrotondata' }, { id: 'c', label: 'Nessuna delle risposte proposte' }, { id: 'd', label: 'Scavo più o meno profondo eseguito per raggiungere falde idriche' }, { id: 'e', label: 'Linea che unisce i punti più depressi di una valle', isCorrect: true } ], courseLevel: 'base', weight: 3, moduleName: 'Glossario' },
  { id: 'q4', kind: 'knowledge', type: 'single', tag: 'Abbigliamento', scenario: 'Stai scendendo verso l\'Abbazia di S. Pietro in Valle in un bosco a prevalenza di leccio e pino d\'Aleppo quando all\'improvviso inizia a grandinare violentemente.', question: 'Come ti comporteresti?', options: [ { id: 'a', label: 'Rallenti ma continui a camminare' }, { id: 'b', label: 'Indossi la mantella e continui a scendere' }, { id: 'c', label: 'Ti ripari sotto un albero indossando il guscio', isCorrect: true }, { id: 'd', label: 'Ti fermi, indossi il windstopper e aspetti che finisca di grandinare' }, { id: 'e', label: 'Nessuna delle precedenti' } ], courseLevel: 'base', weight: 4, moduleName: 'Abbigliamento' },
  { id: 'q5', kind: 'knowledge', type: 'single', tag: 'Attrezzatura Base', question: 'Qual è il carico ideale dello zaino in relazione al peso corporeo?', options: [ { id: 'a', label: 'Intorno al 10%', isCorrect: true }, { id: 'b', label: 'Tra il 15 e il 20%' }, { id: 'c', label: 'Il 25%' }, { id: 'd', label: 'Dipende dall\'età e dall\'allenamento' }, { id: 'e', label: 'L\'unica cosa che conta è che abbia una capienza di almeno 25 litri' } ], courseLevel: 'base', weight: 5, moduleName: 'Attrezzatura I' },
  { id: 'q6', kind: 'knowledge', type: 'single', tag: 'Comportamenti Ecocompatibili', scenario: 'Durante una uscita didattica sui Monti Prenestini un allievo dopo aver mangiato una banana getta in mezzo ai rovi la buccia.', question: 'Come valuti il suo comportamento?', options: [ { id: 'a', label: 'Corretto, la buccia è degradabile da sei mesi a due anni' }, { id: 'b', label: 'Opinabile' }, { id: 'c', label: 'Corretto, sta lasciando del cibo per gli animali selvatici' }, { id: 'd', label: 'Sbagliato', isCorrect: true }, { id: 'e', label: 'Corretto, non posso appesantire lo zaino con i rifiuti organici' } ], courseLevel: 'base', weight: 6, moduleName: 'Comportamenti Ecocompatibili' },
  { id: 'q7', kind: 'knowledge', type: 'single', tag: 'Fattore di Scala', question: 'Individuo su una carta topografica con scala 1:25000 due punti notevoli. Indicando con C la loro distanza sulla carta e con T la loro distanza reale sul terreno quando potrò affermare che C = T?', options: [ { id: 'a', label: 'Sempre' }, { id: 'b', label: 'Se e solo se la distanza tra i due punti viene percorsa in piano', isCorrect: true }, { id: 'c', label: 'Quando il fattore di scala è uguale a 1' }, { id: 'd', label: 'Solo se i due punti notevoli sono alla stessa quota' }, { id: 'e', label: 'Mai' } ], courseLevel: 'base', weight: 7, moduleName: 'Lettura e Interpretazione di una Carta Topografica: Fattore di Scala' },
  { id: 'q8', kind: 'knowledge', type: 'single', tag: 'Calzature e cura del piede', scenario: 'Sei in Costiera Amalfitana e splende il sole. Per percorrere il Sentiero degli Dèi, da Bomerano a Positano,', question: 'Quale calzatura sceglieresti?', options: [ { id: 'a', label: 'Scarpe da ginnastica' }, { id: 'b', label: 'Una classica pedula', isCorrect: true }, { id: 'c', label: 'Infradito' }, { id: 'd', label: 'Un sandalo da escursionismo' }, { id: 'e', label: 'Una qualsiasi tra le precedenti' } ], courseLevel: 'base', weight: 8, moduleName: 'Calzature e Cura del Piede' },
  { id: 'q9', kind: 'knowledge', type: 'single', tag: 'Alimentazione', scenario: 'Escursione invernale con le ciaspole da Campo dell\'Osso a Monte Autore. Hai con te una borraccia contenente 1,5 litri di acqua.', question: 'Qual\' è la gestione ottimale di questo principio nutritivo?', options: [ { id: 'a', label: 'Bevo quando ho sete' }, { id: 'b', label: 'Bevo ad intervalli regolari anche se non ho sete', isCorrect: true }, { id: 'c', label: 'Cerco di bere il meno possibile per non perdere tempo visto che procedo lentamente e le ore di luce sono poche' }, { id: 'd', label: 'Bevo quando arrivo alla meta e mi fermo per mangiare ed ammirare il panorama' }, { id: 'e', label: 'Esaurisco l\'acqua durante la salita, nel ritorno potrei dissetarmi con la neve.' } ], courseLevel: 'base', weight: 9, moduleName: 'Alimentazione' },
  { id: 'q10', kind: 'knowledge', type: 'single', tag: 'Lettura ed interpretazione di una carta topografica', scenario: 'Per l\'uscita nella Riserva Naturale di Monte Mario sto utilizzando una fotocopia della carta topografica ufficiale ormai introvabile.', question: 'Quali caratteristiche della carta sono esattamente riprodotte nella fotocopia?', options: [ { id: 'a', label: 'Le distanze' }, { id: 'b', label: 'I simboli' }, { id: 'c', label: 'La scala' }, { id: 'd', label: 'L\'equidistanza', isCorrect: true }, { id: 'e', label: 'Tutte le precedenti' } ], courseLevel: 'base', weight: 10, moduleName: 'Lettura e Interpretazione di una Carta Geografica' },

  // --- SEZIONE 3: DOMANDE DI MERITO (DOMANDE 11-20 INTERMEDIO) ---
  { id: 'q11', kind: 'knowledge', type: 'single', tag: 'Sentieristica', question: 'La rete sentieristica del CAI permette di identificare sul terreno un sentiero attraverso una numerazione di tre cifre. Quali di queste cifre indicano il numero del sentiero?', options: [ { id: 'a', label: 'Le prime due, l\'ultima indica la zona' }, { id: 'b', label: 'Le ultime due, la prima indica il settore', isCorrect: true }, { id: 'c', label: 'Tutte e tre' }, { id: 'd', label: 'Le prime due, l\'ultima indica l\'area' }, { id: 'e', label: 'Nessuna delle precedenti' } ], courseLevel: 'intermedio', weight: 1, moduleName: 'Sentieristica' },
  { id: 'q12', kind: 'knowledge', type: 'single', tag: 'Allenamento', question: 'Se ti dicessi che con l\'esercizio e la costanza puoi perfezionare la tua respirazione nella camminata, quale atteggiamento metteresti in atto?', options: [ { id: 'a', label: 'Evito il sovrappeso e il fumo' }, { id: 'b', label: 'Sincronizzo il respiro con il movimento delle braccia' }, { id: 'c', label: 'Eseguo una respirazione completa e diaframmatica' }, { id: 'd', label: 'Devo concentrarmi sull\'espirazione' }, { id: 'e', label: 'Tutti i precedenti', isCorrect: true } ], courseLevel: 'intermedio', weight: 2, moduleName: 'Allenamento' },
  { id: 'q13', kind: 'knowledge', type: 'single', tag: 'Prevenzione Pericoli', scenario: 'Ti trovi a pernottare in un rifugio ad una quota superiore al limite del pascolo, e stai studiando il sentiero da percorrere l\'indomani sapendo che sarà una bella giornata. Il sentiero passa ai piedi di una parete rocciosa.', question: 'In quale momento della giornata devi evitare di trovarti in quel tratto?', options: [ { id: 'a', label: 'Nelle prime ore del giorno', isCorrect: true }, { id: 'b', label: 'Quando il sole è allo zenit' }, { id: 'c', label: 'Nelle prime ore del pomeriggio, per possibili temporali' }, { id: 'd', label: 'Al tramonto' }, { id: 'e', label: 'Durante la notte' } ], courseLevel: 'intermedio', weight: 3, moduleName: 'Prevenzione Pericoli' },
  { id: 'q14', kind: 'knowledge', type: 'single', tag: 'Nozioni di Geografia Fisica', question: 'Nella comprensione del paesaggio è fondamentale conoscere i cosiddetti piani altitudinali. Se dovessi camminare tra boschi di latifoglie con faggi e betulle sono certo di trovarmi:', options: [ { id: 'a', label: 'In un piano collinare (100-350m)' }, { id: 'b', label: 'In un piano submontano superiore (600-1200m)' }, { id: 'c', label: 'In un piano montano inferiore (800-1400m)', isCorrect: true }, { id: 'd', label: 'In un piano montano superiore (1400-2000m)' }, { id: 'e', label: 'In un piano alpino inferiore (2000-2400m)' } ], courseLevel: 'intermedio', weight: 4, moduleName: 'Nozioni di Geografia Fisica' },
  { id: 'q15', kind: 'knowledge', type: 'single', tag: 'Primo Soccorso', question: 'In Italia sono presenti molti tipi di serpenti ma solo quattro appartengono alla famiglia dei Viperidi e sono velenosi. Come si soccorre il morso di una vipera?', options: [ { id: 'a', label: 'Pratico un taglio a croce congiungente i morsi e poi cauterizzo la ferita' }, { id: 'b', label: 'Chiamo i soccorsi ed aspetto' }, { id: 'c', label: 'Metto a riposo l\'infortunato e applico un bendaggio compressivo a monte del morso', isCorrect: true }, { id: 'd', label: 'Uso il siero antivipera e poi chiamo i soccorsi' }, { id: 'e', label: 'Chiamo i soccorsi e accompagno velocemente a valle l\'infortunato' } ], courseLevel: 'intermedio', weight: 5, moduleName: 'Primo Soccorso' },
  { id: 'q16', kind: 'knowledge', type: 'single', tag: 'Ecologia ed Etica', question: 'Sapendo che camminare in natura altera i comportamenti abituali della fauna selvatica, individua questi disturbi dal più lieve al più grave.', options: [ { id: 'a', label: 'Fuga, stato di allerta, riduzione degli spostamenti, abbandono dei piccoli, interruzione delle attività' }, { id: 'b', label: 'Stato di allerta, interruzione delle attività, fuga, riduzione degli spostamenti, abbandono dei piccoli' }, { id: 'c', label: 'Riduzione degli spostamenti, abbandono dei piccoli, fuga, interruzione delle attività, stato di allerta' }, { id: 'd', label: 'Stato di allerta, fuga, interruzione delle attività, riduzione degli spostamenti, abbandono dei piccoli', isCorrect: true }, { id: 'e', label: 'Interruzione delle attività, stato di allerta, riduzione degli spostamenti, abbandono dei piccoli, fuga' } ], courseLevel: 'intermedio', weight: 6, moduleName: 'Ecologia ed Etica' },
  { id: 'q17', kind: 'knowledge', type: 'single', tag: 'Orientamento Strumentale', scenario: 'Sono in bellissimo bosco di conifere in Val Pusteria e sto percorrendo la Romerweg da Dobbiaco a Monguelfo.', question: 'Voglio conoscere esattamente la mia posizione, quale strumento utilizzeresti?', options: [ { id: 'a', label: 'La carta topografica' }, { id: 'b', label: 'La bussola' }, { id: 'c', label: 'L\'altimetro' }, { id: 'd', label: 'Solo carta ed altimetro', isCorrect: true }, { id: 'e', label: 'Carta, bussola ed altimetro' } ], courseLevel: 'intermedio', weight: 7, moduleName: 'Orientamento Strumentale' },
  { id: 'q18', kind: 'knowledge', type: 'single', tag: 'Attrezzatura II', scenario: 'Sto percorrendo il sentiero che da Balme (1432m) arriva al Rifugio Gastaldi (2659m). Durante l\'ascesa l\'altimetro, anche se continuamente tarato, mi indica sempre una quota inferiore a quella indicata sulla carta.', question: 'Che conclusioni posso trarre?', options: [ { id: 'a', label: 'Il tempo tende a migliorare', isCorrect: true }, { id: 'b', label: 'Nessuna, probabilmente lo strumento non funziona' }, { id: 'c', label: 'Il tempo tende a peggiorare' }, { id: 'd', label: 'Sto percorrendo un sentiero diverso da quello scelto' }, { id: 'e', label: 'La carta non è accurata' } ], courseLevel: 'intermedio', weight: 8, moduleName: 'Attrezzatura II' },
  { id: 'q19', kind: 'knowledge', type: 'single', tag: 'Orientamento Strumentale', question: 'L\'uso della bussola richiede alcune accortezze per non cadere in errori grossolani. In quale delle situazioni seguenti posso dire di aver operato correttamente?', options: [ { id: 'a', label: 'Tengo il piano della bussola inclinato di circa 20° rispetto al terreno per poter vedere agevolmente l\'ago magnetico' }, { id: 'b', label: 'Posiziono la bussola accanto al cellulare per poter confrontare l\'angolo indicato dalla bussola con quello dello smartphone' }, { id: 'c', label: 'Posiziono la bussola in modo che la freccia di direzione coincida sempre con quella di orientamento' }, { id: 'd', label: 'Devo tener conto della declinazione magnetica', isCorrect: true }, { id: 'e', label: 'Tengo la bussola orizzontale davanti a me sapendo che l\'ago punta verso il nord geografico' } ], courseLevel: 'intermedio', weight: 9, moduleName: 'Orientamento Strumentale' },
  { id: 'q20', kind: 'knowledge', type: 'single', tag: 'Orientamento Strumentale', question: 'Ho perso il sentiero e voglio capire la mia posizione. Dì cosa ho bisogno?', options: [ { id: 'a', label: 'Della carta, della bussola e di due punti visibili noti', isCorrect: true }, { id: 'b', label: 'È sufficiente l\'altimetro' }, { id: 'c', label: 'Basta la bussola e il clinometro' }, { id: 'd', label: 'Riconoscere un punto visibile e la carta' }, { id: 'e', label: 'Non serve altro che la bussola' } ], courseLevel: 'intermedio', weight: 10, moduleName: 'Orientamento Strumentale' }
];
...
function AltourTacticsEngine({ onClose }: Props) {
  ...
  const handleSingleTap = (optionId: string) => {
    if (optionId === OTHER_ID || optionId === 'e' && step.allowOther) {
  ...
  // --- ALGORITMO PREDITTIVO A PUNTEGGIO E PESI PONDERATI ---
  const result = useMemo(() => {
    if (Object.keys(answers).length < STEPS.length) return null;

    const knowledgeSteps = STEPS.filter(s => s.kind === 'knowledge');
    let score = 0;
    const wrongAnswers: { id: string, weight: number, courseLevel: string, moduleName: string }[] = [];
    
    knowledgeSteps.forEach(s => {
      const chosenId = answers[s.id]?.optionIds?.[0];
      const correctOption = s.options.find(o => o.isCorrect);
      
      if (chosenId === correctOption?.id) {
        score += s.weight || 0;
      } else {
        wrongAnswers.push({
          id: s.id,
          weight: s.weight || 0,
          courseLevel: s.courseLevel || 'base',
          moduleName: s.moduleName || 'Generico'
        });
      }
    });

    let level: CourseLevel = 'base';
    let suggestedModule: string | null = null;
    
    // Logica di assegnazione del Livello e del Modulo in base ai Range di Punteggio (max 110)
    if (score <= 66) {
      level = 'base';
      suggestedModule = null; // Nessun modulo specifico per 0-66
    } else if (score >= 67 && score <= 99) {
      level = 'intermedio';
      // Trova l'errore del corso base con il peso maggiore
      const baseErrors = wrongAnswers.filter(w => w.courseLevel === 'base');
      if (baseErrors.length > 0) {
        baseErrors.sort((a, b) => b.weight - a.weight);
        suggestedModule = baseErrors[0].moduleName;
      }
    } else if (score >= 100) {
      level = 'avanzato';
      // Trova l'errore in assoluto (base o intermedio) con il peso maggiore
      if (wrongAnswers.length > 0) {
        wrongAnswers.sort((a, b) => b.weight - a.weight);
        suggestedModule = wrongAnswers[0].moduleName;
      }
    }

    // Identifica se l'utente aspira a diventare GAE
    const objectiveIds = answers['obiettivo']?.optionIds ?? [];
    const wantsGAE = objectiveIds.includes(GAE_OPTION_ID);
    
    return { level, score, wantsGAE, suggestedModule };
  }, [answers]);
  ...
  const canContinueMulti = draftSelection.length > 0 && (!showOtherInput || otherDraft.trim().length > 0 || draftSelection.some(id => id !== 'e' && id !== OTHER_ID));
  ...
  return (
    <>
        ...
        <>
          <main className="flex-1 overflow-y-auto px-5 py-6 bg-stone-50">
            ...
            <div className="space-y-3 pb-2">
              ...
              {step.allowOther && (
                <div 
                  className={`border-2 rounded-2xl transition-all duration-200 overflow-hidden ${isOptionSelected(OTHER_ID) || isOptionSelected('e') ? '' : 'border-stone-200 bg-white'}`}
                  style={(isOptionSelected(OTHER_ID) || isOptionSelected('e')) ? { backgroundColor: BRAND_BG_LIGHT, borderColor: BRAND_COLOR } : {}}
                >
                  <button
                    onClick={() => step.type === 'single' ? handleSingleTap('e') : handleMultiToggle('e')}
                    className="w-full text-left p-4 text-[15px] font-semibold flex items-center justify-between"
                    style={{ color: (isOptionSelected(OTHER_ID) || isOptionSelected('e')) ? '#2d5063' : '#44403c' }}
                  >
                    Altro…
                    {step.type === 'multi' && (
                      <span 
                        className={`w-6 h-6 rounded-md border-2 flex items-center justify-center shrink-0 transition-colors ${(isOptionSelected(OTHER_ID) || isOptionSelected('e')) ? '' : 'border-stone-300 bg-stone-50'}`}
                        style={(isOptionSelected(OTHER_ID) || isOptionSelected('e')) ? { backgroundColor: BRAND_COLOR, borderColor: BRAND_COLOR } : {}}
                      >
                        {(isOptionSelected(OTHER_ID) || isOptionSelected('e')) && <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M5 13l4 4L19 7"/></svg>}
                      </span>
                    )}
                  </button>
      ...
      {/* --- SCENARIO 3: REPORT ACADEMY FINALE CON RACCOMANDAZIONE MODULI --- */}
      {phase === 'RESULT' && result && (
        <main className="flex-1 overflow-y-auto px-5 py-6 pb-[max(2rem,env(safe-area-inset-bottom))] bg-stone-50 flex flex-col items-center">
          <div className="w-full max-w-sm flex flex-col items-center text-center space-y-6 py-4 my-auto animate-in fade-in zoom-in-95 duration-500">
            ...
            <p className="text-stone-600 text-sm sm:text-[15px] font-medium leading-relaxed max-w-[320px] shrink-0">
              In base alle risposte fornite nel test tecnico (<strong style={{ color: BRAND_COLOR }}>punteggio totale: {result.score} / 110</strong>), ti suggeriamo di consolidare la tua formazione iscrivendoti al nostro corso di livello {result.level}.
            </p>

            {/* Raccomandazione Modulo Specifica come da richiesta */}
            {result.suggestedModule && (
              <div className="w-full bg-white p-6 rounded-3xl border border-stone-200 text-left shadow-xl shadow-stone-200/40 relative overflow-hidden shrink-0">
                ...
                >
                  <span>MODULO DI APPROFONDIMENTO CONSIGLIATO</span>
                </div>
                <h3 className="text-xl font-black text-stone-900 leading-tight mb-2">{result.suggestedModule}</h3>
              </div>
            )}
              ...
              <div className="w-full bg-stone-100 border border-stone-200 p-5 rounded-2xl text-left shrink-0 mt-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-[12px] text-stone-600 font-medium leading-relaxed">
                    Il percorso per acquisire le competenze da <strong className="text-stone-900">Guida Ambientale Escursionistica</strong> prevede iter formativi specifici. La segreteria ti contatterà presto.
                  </p>
                </div>
              </div>
            )}
