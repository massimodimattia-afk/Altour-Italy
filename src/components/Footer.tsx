...
export default function Footer() {
  return (
    <footer className="bg-[#2a2723] text-stone-400 mt-auto border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 sm:gap-10">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed text-stone-400 max-w-xs">
              ...
              outdoor per scoprire le meraviglie delle nostre montagne con guide
              esperte.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col space-y-4">
              <a
                ...
                className="flex items-center space-x-3 text-stone-400 hover:text-brand-sky transition-colors group"
              >
              ...
              >
                ...
                <span className="text-sm font-medium">+39 328 1613762</span>
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-white/5 mt-12 pt-8 text-center flex flex-col gap-3">
          <p className="text-[10px] text-stone-500 uppercase tracking-[0.2em] font-medium">
            &copy; {new Date().getFullYear()} Altour Italy. Esplora con
            consapevolezza.
          </p>
